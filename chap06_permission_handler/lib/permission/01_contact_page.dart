...
class _ContactsPageState extends State<ContactsPage> {
  ...
  // 권한 체크 및 연락처 가져오는 메소드 (flutter에서 비동기 함수 반환객체는 Future 여야 한다.)Future 는 Promise 객체와 같은것
  ...
  Future<void> _addContact(String name, String phone) async {
    ...
    if (await FlutterContacts.requestPermission()) {
      final newContact = Contact() // cascade operator
        ..name.first = name // Contact 안에 있는 속성 객체들을 가져오기 위해서 ..(cascade 연산자 사용)
        ..phones = [Phone(phone)];
