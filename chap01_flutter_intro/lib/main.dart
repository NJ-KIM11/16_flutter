...
* */
  ...
  Widget build(BuildContext context) {
    ...
    *  - home = 앱의 기본 화면을 설정한다. 일반적으로 첫번째 화면을 표시하는 위젯
    *  - routes = 라우팅을 정의하는데 사용한다.
    * */
    // 안드로이드(구글) 느낌의 기본 플러터 테마 (<-->cupertino design)
    return MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
      ...
      home: MyHomePage(title: "Our first Flutter App"),
    );
  }
}
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    *  Flutter 에서 기본적인 화면 구조를 쉽게 설정할 수 있게 해주는 위젯 속성
