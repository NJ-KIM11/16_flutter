...
*  - 다양한 도구와 서비스를 제공하여 개발 시간을 단축하고, 효율성을
*  높일 수 있다.
*
*  - db, 인증, 서버가 없을 시 백엔드 코드 실행 등도 제공하지만,
*  우리는 spring 과 mysql 을 사용하므로 우리는 알림만 사용해볼 것..
*  - 클라우드 저장소도 1GB 무료로 제공한다..
*
*  Firebase Cloud Messaging(FCM)
*  - 무료 푸시 알림 서비스, 사용자에게 실시간 메시지를 보낼 수 있다.
*
* -- Firebase 에 등록된 앱을 사용하는 기기에 토큰 발행
* -- 토큰이 spring 서버에 저장
* -- 토큰들로 구분해서 서버에서 firebase 로 FCM 요청
* */
